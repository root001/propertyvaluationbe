...
public record FacilityRequest(FacilityType facilityType, Catergory catergory, FacilityPurpose purpose, Integer facilityTerm, String ccy, Double amount, boolean isHousingLoan, boolean isFosRef, ValuationType valuationType, String fosReferenceNo, Borrower mainBorrower, List<Borrower> jointBorrower, List<File> uploadedFiles, List<Comment> comments) {
}
